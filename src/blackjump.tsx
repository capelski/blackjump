...
export const BlackJump: React.FC = () => {
  ...
  const isSplitEnabled =
    currentHand !== undefined && canSplit(currentHand, player.hands.length, gameConfig.casinoRules);
  ...
  const startTrainingRound = (playerHand: Hand, dealerHand: Hand) => {
    ...
    if (gameConfig.casinoRules[CasinoRulesKeys.blackjackPeek] && canBeDealerBlackjack(dealerHand)) {
      setPeeking(true);
      setTimeout(() => {
        setPeeking(false);
      ...
      <NavigationContainer ref={navigationRef}>
        ...
        >
          ...
          <Stack.Screen name={RouteNames.handDecisions}>
            {(props) => <HandDecisions casinoRules={gameConfig.casinoRules} route={props.route} />}
          </Stack.Screen>
