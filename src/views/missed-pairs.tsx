      ...
      >
        {props.missedTrainingPairs.length === 0 ? (
          ...
          Object.values(props.missedTrainingPairs).map((missedTrainingPair) => {
            ...
            return (
              <View
                key={missedTrainingPair.handCode + '-' + missedTrainingPair.dealerSymbol}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Text style={boldTextProperties}>{missedTrainingPair.dealerSymbol}</Text>
                  </View>
                  <View
                    style={{
                      ...
                      onPress={
                        props.onBoardingStep > -1 || props.phase !== Phases.finished
                          ...
                          : () => {
                              ...
                              props.startTrainingRound(trainingPair.player, trainingPair.dealer);
