    ...
    <React.Fragment>
      ...
      >
        <Text style={{ color: 'white', fontSize: 20, marginBottom: 16 }}>
          In Hole card games the dealer's hand immediately receives its second card face down (the
          hole card) after receiving its first card face up.
        </Text>
        ...
        <Text style={{ color: 'white', fontSize: 20, marginBottom: 16, marginTop: 16 }}>
          When Blackjack Peek is enabled and the dealer's hand could be a blackjack (e.g. the first
          card is an ace or a ten value card), the dealer peeks at the hole card.
        </Text>
        ...
        <Text style={{ color: 'white', fontSize: 20, marginBottom: 16, marginTop: 16 }}>
          If the hole card makes the dealer's hand a blackjack, the dealer reveals the hole card
          winning over all players' non blackjack hands.
        </Text>
