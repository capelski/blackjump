              ...
              <Pressable
                onPress={
                  props.onBoardingStep > -1
                    ? undefined
                    : () => {
                        setUnfoldedHand(unfoldedHand !== handCode ? handCode : undefined);
                      }
                }
                style={{ width: '100%' }}
              >
                ...
                <React.Fragment>
                  <View
                    style={{
                      ...
                      opacity: props.phase === Phases.finished ? undefined : 0.3,
                    }}
                  >
                    {getObjectKeys(trainingHandStatus).map((dealerSymbol) => {
                      const backgroundColor =
                        trainingHandStatus[dealerSymbol] === TrainingPairStatus.untrained
                          ? untrainedColor
                          : trainingHandStatus[dealerSymbol] === TrainingPairStatus.passed
                          ? 'lightgreen'
                          : 'lightcoral';
                      ...
                      return (
                        <Pressable
                          key={dealerSymbol}
                          onPress={
                            props.onBoardingStep > -1 || props.phase !== Phases.finished
                              ? undefined
                              : () => {
                      ...
                      props.onBoardingStep > -1
                        ...
                        : () => {
                            props.navigation.navigate(RouteNames.handDecisions, {
                              trainingHand: props.trainingHands[handCode],
                            });
                          }
                    }
                  >
