    ...
    >
      ...
      >
        {isProgressBlocked && (
          ...
          >
            ⚠️ Selected hands are blocking progress. Modify the selection or disable Selected hands
      ...
      >
        ...
        <SplitsNumberPicker casinoRules={casinoRules} onValueChange={casinoRuleChangeHandler} />
          ...
          >
            ...
            {Object.values(trainingHands).map((trainingHand) => (
              <Pressable
                ...
                style={{
                  alignItems: 'center',
                  backgroundColor: selectedHands[trainingHand.code] ? standColor : undefined,
                  paddingVertical: 4,
                  width: '33.33%',
                }}
              >
