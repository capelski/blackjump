...
export const ConfigBar: React.FC<ConfigBarProps> = (props) => {
    const earningsColor =
        props.playerCash > 0 ? '#5cb85c' : props.playerCash < 0 ? '#dc3545' : 'white';
    return (
        <View
            style={{
                flexDirection: 'row',
        ...
        >
            <View style={{ flexDirection: 'row' }}>
                <Text style={{ color: earningsColor, fontSize: 20 }}>
                    {`${props.playerCash > 0 ? '+' : ''}${props.playerCash}`}
                </Text>
                <Svg
                    height={24}
                    viewBox="0 0 468 468"
            ...
            <View style={{ flexDirection: 'row' }}>
                <Text style={textStyles}>
                    {props.totalAttemptedDecisions &&
                        Math.floor(
                            (props.totalRightDecisions * 1000) / props.totalAttemptedDecisions
                        ) / 10}
                </Text>
                <Svg height={28} viewBox="0 0 1000 1000" width={28} style={{ marginLeft: 4 }}>
                    <Path
