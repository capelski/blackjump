...
export const NavBar: React.FC<NavBarProps> = (props) => {
    ...
    const passedHandsRatePosition = useMemo(() => new Animated.Value(0), []);
    const trainedHandsRatePosition = useMemo(() => new Animated.Value(0), []);
    ...
    useEffect(() => {
        animateIndicator(passedHandsRatePosition);
    }, [passedHandsRate]);

    useEffect(() => {
        animateIndicator(trainedHandsRatePosition);
    }, [trainedHandsRate]);
    ...
    return (
        ...
        >
            ...
            <Animated.View
                style={{
                    alignItems: 'center',
                    transform: [{ translateX: passedHandsRatePosition }],
                    width: '30%'
                }}
            >
                <TouchableOpacity
                ...
                >
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={textStyles}>{passedHandsRate}%</Text>
                        <Svg
                            height={28}
            ...
            <Animated.View
                style={{
                    alignItems: 'center',
                    transform: [{ translateX: trainedHandsRatePosition }],
                    width: '30%'
                }}
            >
                <TouchableOpacity
                ...
                >
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={textStyles}>{trainedHandsRate}%</Text>
                        <Svg
                            height={28}
                            viewBox="0 0 1000 1000"
                            width={28}
