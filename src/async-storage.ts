          ...
          storedGameConfig && storedGameConfig.casinoRules !== undefined
            ? {
                [CasinoRulesKeys.blackjackPeek]:
                  storedGameConfig.casinoRules[CasinoRulesKeys.blackjackPeek] !== undefined
                    ? storedGameConfig.casinoRules[CasinoRulesKeys.blackjackPeek]
                    : currentGameConfig.casinoRules[CasinoRulesKeys.blackjackPeek],
                [CasinoRulesKeys.dealerHitsSoft17]:
                  storedGameConfig.casinoRules[CasinoRulesKeys.dealerHitsSoft17] !== undefined
                    ? storedGameConfig.casinoRules[CasinoRulesKeys.dealerHitsSoft17]
                    : currentGameConfig.casinoRules[CasinoRulesKeys.dealerHitsSoft17],
                [CasinoRulesKeys.doubling]:
                  storedGameConfig.casinoRules[CasinoRulesKeys.doubling] !== undefined
                ...
                [CasinoRulesKeys.doublingAfterSplit]:
                  storedGameConfig.casinoRules[CasinoRulesKeys.doublingAfterSplit] !== undefined
                    ? storedGameConfig.casinoRules[CasinoRulesKeys.doublingAfterSplit]
                    : currentGameConfig.casinoRules[CasinoRulesKeys.doublingAfterSplit],
                [CasinoRulesKeys.hitSplitAces]:
                  storedGameConfig.casinoRules[CasinoRulesKeys.hitSplitAces] !== undefined
                ...
                [CasinoRulesKeys.splitsNumber]:
                  storedGameConfig.casinoRules[CasinoRulesKeys.splitsNumber] !== undefined
                ...
                [CasinoRulesKeys.surrender]:
                  storedGameConfig.casinoRules[CasinoRulesKeys.surrender] !== undefined
...
export const updateHasCompletedOnboarding = (hasCompletedOnboarding: boolean) => {
  AsyncStorage.setItem(hasCompletedOnboardingKey, JSON.stringify(hasCompletedOnboarding)).catch(
    () => {},
  );
};
...
export const updatePlayerEarningsHistorical = (
  ...
  AsyncStorage.setItem(playerEarningsHistoricalKey, JSON.stringify(playerEarningsHistorical)).catch(
    () => {},
  );
};
